...
int main() {
	...
	while (loop) {
		...
		drawCircle(img, center, 20);
		drawCircle(img, center, 50);
		drawCircle(img, center, 80);
		drawCircle(img, center, 110);
